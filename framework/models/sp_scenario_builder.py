# SPScenarioBuilder - builds a scenario using one of the three
# generation methods, or combines scenarios using one of the seven
# combination methods. Multithreaded version
...
class NoValidSolutionException(Exception):
    pass
