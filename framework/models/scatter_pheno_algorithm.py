...
from framework.models.scatter_pheno_scenario_builder \
        import ScatterPhenoScenarioBuilder
...
class ScatterPhenoAlgorithm:
    ...
    def _run_algorithm2(self):
        ...
        scenario_builder = ScatterPhenoScenarioBuilder(self._data,
                                                       self._variables)
    ...
    def _combine(self, container, scenario_builder):
        ...
        for combination in combinations:
            ...
            try:
                ...
                pass  # Worse than anything in ref_set, does not qualify
    ...
    def _improve(self, individual, scenario_builder):
        ...
        for var in candidate_list:
            ...
            if new_scenario.same(individual) or not new_scenario.valid():
                continue
    ...
    def _hack_data(self, data):
        ...
        if self._scenario == "simple_ml":
            needed_vars.append(formats.DW_PLANT)
